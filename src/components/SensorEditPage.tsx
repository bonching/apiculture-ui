...
import {ArrowLeft, Database, Link2, Save, Shield, TrendingUp} from "lucide-react";
import {Beehive, DataCaptureType, Farm, Sensor, SensorSystem} from "../types";
            ...
            <div className="bg-amber-500 text-white p-4 sticky top-0 z-10 shadow-md">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <div
                            className="opacity-90">{isNewSensor ? "Create a new sensor" : "Update sensor details"}</div>
                    </div>
                </div>
            </div>
            ...
            <div className="p-4 space-y-4">
                    ...
                    <CardContent className="space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-muted-foreground">
                                Select one or more metrics this sensor can capture (e.g., BME680 captures temperature,
                ...
                <Card>
                    ...
                    <CardContent className="space-y-3">
                        <p className="text-muted-foreground">
                            Select which system(s) this sensor should be assigned to. Harvesting is mutually exclusive
                            from Data Collection and Defense.
                        </p>
                                    ...
                                    <div className="flex-1">
                                        ...
                                        {(system.id === "defense" || system.id === "data_collection") &&
                                            formData.systems.includes(system.id) && (
                                                <Badge variant="outline"
                                                       className="mt-2 bg-blue-100 text-blue-800 border-blue-300">
                    ...
                    <CardContent className="space-y-4">
                        <div className="space-y-2">
                            <Label htmlFor="farmId">
                                Farm {!beehiveLinkingDisabled &&
                                <span className="text-muted-foreground">(Optional - helps filter beehives)</span>}
                                {beehiveLinkingDisabled &&
                                    <span className="text-muted-foreground"> (Disabled for Harvesting System)</span>}
                            </Label>
                            <Select
                        ...
                        <div className="space-y-2">
                            ...
                            <Select
                                ...
                                onValueChange={(value) => setFormData({
                                    ...formData,
                                    beehiveId: value === "none" ? null : value
                                })}
                                disabled={beehiveLinkingDisabled || isFarmAndBeehiveLocked}
                            >
                                <SelectTrigger>
                        ...
                        <div className="space-y-2">
                            ...
                            <RadioGroup
                                ...
                                onValueChange={(value) => !hiveLocationReadonly && setFormData({
                                    ...formData,
                                    hiveLocation: value as any
                                })}
                            ...
                            >
                                <div className="flex items-center space-x-2">
                                    ...
                                    <Label htmlFor="brood"
                                           className={hiveLocationReadonly ? "opacity-50" : "cursor-pointer"}>Brood</Label>
                                </div>
                                <div className="flex items-center space-x-2">
                                    <RadioGroupItem value="honey_super" id="honey_super"
                                                    disabled={hiveLocationReadonly}/>
                                    <Label htmlFor="honey_super"
                                           className={hiveLocationReadonly ? "opacity-50" : "cursor-pointer"}>Honey
                                        Super</Label>
                                </div>
                                <div className="flex items-center space-x-2">
                                    <RadioGroupItem value="external" id="external" disabled={hiveLocationReadonly}/>
                                    <Label htmlFor="external"
                                           className={hiveLocationReadonly ? "opacity-50" : "cursor-pointer"}>External</Label>
                                </div>
                            </RadioGroup>
                            {hiveLocationReadonly && (
