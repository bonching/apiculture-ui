...
import {AlertCircle, AlertTriangle, ArrowUpDown, BarChart3, Eye, Info, LayoutGrid, Radio} from "lucide-react";
                        ...
                        {graphType === "stacked" && (
                            <Card>
                                <CardHeader>
                                    ...
                                    <CardDescription>Alert distribution across time periods by
                                        severity</CardDescription>
                                </CardHeader>
                                <CardContent>
                                    <ResponsiveContainer width="100%" height={300}>
                                                    ...
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        {!alert.read && (
                                                            <Badge variant="outline"
                                                                   className="bg-orange-200 text-orange-800 border-orange-400 font-semibold">
                                                                New
                                                            </Badge>
                                                        )}
                                                    </div>
