...
export default function App() {
    ...
    const {
        ...
        error: errorHives
    } = useFetch(API_ROUTES.hiveRoutes);
    const {
        data: sensors,
        setData: setSensors,
        loading: loadingSensors,
        error: errorSensors
    } = useFetch(API_ROUTES.sensorRoutes);
    const {
        data: alerts,
        setData: setAlerts,
    ...
    const {
        ...
        error: errorDeletingFarm,
        mutate: deleteFarm
    } = usePost<Farm>({extractData: true});
    const {
        data: hive,
        loading: deletingHive,
        error: errorDeletingHive,
        mutate: deleteHive
    } = usePost<Farm>({extractData: true});
    const {
        data: sensor,
        loading: deletingSensor,
        error: errorDeletingSensor,
        mutate: deleteSensor
    } = usePost<Farm>({extractData: true});
